...
import com.damd.sirop.databinding.ActivityLoginComandanteBinding;
...
public class LoginComandanteActivity extends AppCompatActivity {

    private ActivityLoginComandanteBinding binding;
...
//    DatabaseReference databaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityLoginComandanteBinding.inflate(getLayoutInflater());
...
//       Firebase
        ...
        //Listeners acciones de los botones al presionarlos
        binding.btnRegistrar.setOnClickListener(view -> startActivity(new Intent(LoginComandanteActivity.this, RegistrarActivity.class)));
    ...
    private void firebaseLogin() {
        ...
        firebaseAuth.signInWithEmailAndPassword(email, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                ...
                Toast.makeText(LoginComandanteActivity.this, "Iniciaste sesion como\n" + email, Toast.LENGTH_SHORT).show();

                if (seleccionSP.getText().toString().equals("Tratador")) {
                    Intent ingTratador = new Intent(LoginComandanteActivity.this, AdminConsoleActivity.class);
                    startActivity(ingTratador);
                } else if (seleccionSP.getText().toString().equals("Comandante")) {
                    Intent ingComandante = new Intent(LoginComandanteActivity.this, ComandanteActivity.class);
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(LoginComandanteActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
